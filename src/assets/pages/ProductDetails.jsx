            ...
            <section className="pt-30">
                <div className="container">
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-5 my-3">
                        <div className={`product-image bg-white rounded-lg shadow p-3 py-8 text-center relative`}>
                        ...
                        <div className="product-info p-2 text-center md:text-left">
                            ...
                            <div className="my-3 text-sm lg:text-lg font-semibold">
                                {
                            ...
                            <p className="text-base lg:text-lg text-gray-500 my-3">{product.description}</p>
